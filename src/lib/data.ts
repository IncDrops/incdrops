...
export const sampleGalleryData = [
    ...
    {
        id: 4,
        name: "AI-Powered Cooking Assistants",
    ...
    {
        id: 5,
        name: "Hyperlocal Social Networks",
...
export const adCardsData = [
  {
    ...
    link: "#",
    content: "The new EV lineup combines cutting-edge tech with sustainable design."
  },
  {
    id: 2,
    industry: "Tech",
    ...
    link: "#",
    content: "Powerful, sleek, and built for the modern professional. Discover the new Pro-Series."
  },
  {
    id: 3,
    ...
    link: "#",
    content: "A revolutionary transparent display and AI integration. The future is in your hand."
  },
  {
    id: 4,
    industry: "Software",
    ...
    link: "#",
    content: "Our new development suite accelerates your projects from concept to launch."
  },
  {
    id: 5,
...
export const blogPosts = [
  ...
  {
    id: 7,
    title: "Your Social Media Toolkit: Must-Have Gadgets for Content Creators",
  ...
  {
    id: 8,
    title: "From Idea to Viral: A Step-by-Step Content Creation Workflow",
  ...
  {
    id: 9,
    title: "Monetizing Your Influence: A Guide to Affiliate Marketing and Sponsored Posts",
  ...
  {
    id: 10,
    title: "The Do's and Don'ts of Hashtag Hijacking: Stay on the Right Side of the Trend",
  ...
  {
    id: 11,
    title: "5 Essential Social Media Scheduling Tools for the Modern Marketer",
  ...
  {
    id: 12,
    title: "The Must-Have Smart Home Gadgets of 2025: From Automated Coffee to AI Assistants",
  ...
  {
    id: 13,
    title: "Next-Gen Wearables: The Smartwatches and Fitness Trackers Defining the Future of Health",
  ...
  {
    id: 14,
    title: "Gaming on the Go: The Top Portable Gaming Gadgets for 2025",
  ...
  {
    id: 15,
    title: "The Future of Work: Gadgets to Supercharge Your Productivity in 2025",
  ...
  {
    id: 16,
    title: "Unboxing the Unexpected: 5 Innovative Gadgets You Didn't Know You Needed",
  ...
  {
    id: 17,
    title: "Travel Smart: The Best Travel Gadgets for the Modern Digital Nomad",
  ...
  {
    id: 19,
    title: "Hands-On Review: Is the New [Product Name] Worth the Hype?",
    summary: "Every year, a handful of gadgets generate massive excitement before they even hit the shelves. Does the new [Product Name] live up to the expectations?",
    image: "/blog/blog-19.png",
  ...
  {
    id: 21,
    title: "The Ultimate Home Office Makeover: Gadgets to Create a Productive Workspace",
  ...
  {
    id: 22,
    title: "How AI is Revolutionizing Marketing: An Introduction to AI-Powered Tools",
  ...
  {
    id: 23,
    title: "Beyond Google Analytics: 5 AI Tools for Deeper Customer Insights",
  ...
  {
    id: 24,
    title: "Predictive Analytics 101: A Guide for Marketers to Forecast Consumer Trends",
  ...
  {
    id: 25,
    title: "Content That Writes Itself? The Best AI Writing Tools for Bloggers and Copywriters",
  ...
  {
    id: 26,
    title: "The Future of SEO: AI-Driven Keyword Research and Content Optimization",
  ...
  {
    id: 27,
    title: "AI for E-commerce: How to Predict Bestsellers and Optimize Your Inventory",
  ...
  {
    id: 28,
    title: "The Ultimate List of AI Trend Forecasting Tools for 2025",
  ...
  {
    id: 29,
    title: "Automate and Accelerate: AI Tools to Streamline Your Marketing Workflow",
  ...
  {
    id: 30,
    title: "Ethical AI in Marketing: Using AI Responsibly and Transparently",
