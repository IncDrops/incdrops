        ...
        <div className="pt-24 pb-16">
            <Card className="bg-card/60 backdrop-blur-lg border-border/20 shadow-lg">
                ...
                <CardContent className="space-y-4 text-foreground/80">
                    ...
                    <h3 className="font-bold text-xl pt-4 font-headline text-primary-foreground">Ezoic Services</h3>
                    ...
                    <p>Ezoic and its partners may use this data in combination with information that has been independently collected to deliver targeted advertisements across various platforms and websites. Ezoic’s partners may also gather additional data, such as unique IDs, advertising IDs, geolocation data, usage data, device information, traffic data, referral sources, and interactions between users and websites or advertisements, to create audience segments for targeted advertising across different devices, browsers, and apps. You can find more information about interest-based advertising and how to manage them at <a href="https://youradchoices.com" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">https://youradchoices.com</a>.</p>
                    <p>You can view Ezoic’s privacy policy at <a href="https://ezoic.com/privacy" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">https://ezoic.com/privacy</a> or for additional information about Ezoic’s advertising and other partners, you can view Ezoic’s advertising partners at <a href="https://www.ezoic.com/privacy-policy/advertising-partners" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">https://www.ezoic.com/privacy-policy/advertising-partners</a>.</p>
